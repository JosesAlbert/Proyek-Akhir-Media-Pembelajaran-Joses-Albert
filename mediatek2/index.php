<?php include("mainheader.php"); ?>
  ...
  <!--   <div class="cloud1"></div>
        ...
        <div style="width:100%; height:auto; margin:20px 0px"></div>
        <div class="house">
            <!-- <div class="boxTau">
                <div class="slideTau">
                    <div class="isi">
...
<div class="modal hide fade" id="Modal2">
  ...
  <div class="modal-body">
   <a href=""><strong>Belajar Komputer</strong></a> adalah media pembelajaran berbasis website. Berisi materi pengenalan komputer dan jaringan. 
   
   <center><hr width=90%></center>
   <strong>Developed by :</strong>
   <center>
   <div class="row-fluid">
   <div class="span4">Joses</div>
   </div>
   </center>
